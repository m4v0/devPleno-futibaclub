...
-- Schema futibaclub
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `futibaclub` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`users` ;
...
-- -----------------------------------------------------
-- Table `futibaclub`.`group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`group` ;

CREATE TABLE IF NOT EXISTS `futibaclub`.`group` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(245) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`groups_users` ;
...
CREATE TABLE IF NOT EXISTS `futibaclub`.`groups_users` (
  ...
  INDEX `fk_groups_users_group1_idx` (`group_id` ASC),
  CONSTRAINT `fk_groups_users_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `futibaclub`.`users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_groups_users_group1`
    FOREIGN KEY (`group_id`)
    REFERENCES `futibaclub`.`group` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`games` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`guessings` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `futibaclub`.`comments` ;
